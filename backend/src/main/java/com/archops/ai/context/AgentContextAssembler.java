...
public class AgentContextAssembler {
    ...
    private static final String IDENTITY_RULES = """
            ...
            4. partitionKey (scope) rules: graph:global | cluster:{elementId} | tag:{slug} | asset:{id}.
    ...
    public String assemble(
        ...
        appendSection(sb, HEADER_RAG, formatRag(userQuery, assets));
        appendSection(sb, HEADER_ARCHITECTURE, formatArchitecture(assets));
    ...
    private String formatRag(String userQuery, List<Long> assetIds) {
        try {
        ...
        RagScope scope = buildScope(assetIds);
    ...
    private String formatArchitecture(List<Long> assetIds) {
    ...
    private static RagScope buildScope(List<Long> assetIds) {
        ...
        return new RagScope(assetIds != null ? assetIds : List.of(), keys);
    }
