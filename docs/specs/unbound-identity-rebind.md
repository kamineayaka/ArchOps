...
**Status**: spec published；工单 01–07 已拆（**01 TDD-done**；frontier = **02**。tracker = `docs/agents/issue-tracker.md`）  
...
- **Next Matt step**: `/implement` `/tdd` **票 02**（frontier）。一次一张；两张 unblocked 时编号最小（02 先于 05）。不要重拆竖切 01–13 或改策展 01–06。不要加改策展 07。
