...
**Status**: spec published；工单 01–07 已拆（**01–04 + 08 TDD-done**；frontier = **05**。tracker = `docs/agents/issue-tracker.md`）  
...
- **Prompt for next chat**: 票 05 路径 [`.scratch/unbound-identity-rebind/issues/05-identity-lost-gates-conflict-pipeline.md`](../../.scratch/unbound-identity-rebind/issues/05-identity-lost-gates-conflict-pipeline.md)。进度见 [`docs/dev-handoff.md`](../dev-handoff.md)。Frontier = 未绑定 05。`/implement` 走 [`docs/agents/tdd.md`](../agents/tdd.md)。不要实现 06–07。票 09 待人排期。
