...
- **Prompt for next chat**: 票 01 开工入口 [`docs/implement-unbound-identity-rebind-01-prompt.md`](../implement-unbound-identity-rebind-01-prompt.md)。进度见 [`docs/dev-handoff.md`](../dev-handoff.md)。Frontier = `.scratch/unbound-identity-rebind/issues/01-infer-identity-lost-unbound-upsert.md`。`/implement` 走 [`docs/agents/tdd.md`](../agents/tdd.md)。
