...
| [x] P1-3 | **密钥轮换文档** | `docs/deployment.md`：轮换 `JWT_SECRET` / `CREDENTIALS_MASTER_KEY` 影响 | 文档可照做 |
| [x] P1-4 | **Embedding 切换指引** | 设置页或知识库 API 返回 reindex 提示文案 | 切换 Provider/dims 后有明确提示 |
