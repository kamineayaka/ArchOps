...
| unbound-identity-rebind | `docs/specs/unbound-identity-rebind.md` | `.scratch/unbound-identity-rebind/issues/`（01–07 已拆；**01–02 TDD-done；frontier = 03**；开工 prompt `docs/implement-unbound-identity-rebind-03-prompt.md`） |
