...
| change-curated-draft | `docs/specs/change-curated-draft.md` | `.scratch/change-curated-draft/issues/`（**01 TDD-done**；02–03 `ready-for-agent` TDD redo；frontier = **02**；04–06 被挡住） |
