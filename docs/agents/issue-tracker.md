...
| unbound-identity-rebind | `docs/specs/unbound-identity-rebind.md` | `.scratch/unbound-identity-rebind/issues/`（01–07 已拆，审计后补 08 / 09；**01–03 + 08 TDD-done；frontier = 04**） |
