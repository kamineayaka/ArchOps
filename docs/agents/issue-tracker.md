...
| unbound-identity-rebind | `docs/specs/unbound-identity-rebind.md` | `.scratch/unbound-identity-rebind/issues/`（01–07 已拆；**frontier = 01**；开工 prompt `docs/implement-unbound-identity-rebind-01-prompt.md`） |
