...
| unbound-identity-rebind | `docs/specs/unbound-identity-rebind.md` | `.scratch/unbound-identity-rebind/issues/`（01–07 已拆；**01 TDD-done；frontier = 02**；开工 prompt `docs/implement-unbound-identity-rebind-02-prompt.md`） |
