...
8. Tickets: 竖切 [.scratch/vertical-slice-mvp/issues/](./.scratch/vertical-slice-mvp/issues/) 已 done；改策展 [.scratch/change-curated-draft/issues/](./.scratch/change-curated-draft/issues/)（**01–06 TDD-done**；本刀闭合）。下一刀 [.scratch/unbound-identity-rebind/issues/](./.scratch/unbound-identity-rebind/issues/)（**01–03 + 08 TDD-done；frontier = 04**；01–03 合同审计报告 [audit-01-03-opus.md](./.scratch/unbound-identity-rebind/audit-01-03-opus.md)，其 C-1 = 票 09，C-3 / S-4 / S-2 是票 04 的义务）
