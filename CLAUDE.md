...
9. [docs/specs/plan-step-assertion.md](./docs/specs/plan-step-assertion.md) — 步骤断言（B3 剩余；**01 TDD-done，本刀闭合**）
...
13. `/implement` → [`docs/agents/implement-kickoff.md`](./docs/agents/implement-kickoff.md). Do not invent a one-off prompt. Historical `docs/implement-*-prompt.md` are superseded for new tickets.
