...
7. Tickets: 竖切 [.scratch/vertical-slice-mvp/issues/](./.scratch/vertical-slice-mvp/issues/) 已 done；改策展 [.scratch/change-curated-draft/issues/](./.scratch/change-curated-draft/issues/)（frontier = 01；开工 [`docs/implement-change-curated-draft-01-prompt.md`](./docs/implement-change-curated-draft-01-prompt.md)）
