...
6. [docs/dev-handoff.md](./docs/dev-handoff.md) — 进度；下一刀见 [docs/grill-next-knife-prompt.md](./docs/grill-next-knife-prompt.md)  
7. Tickets: 竖切 [.scratch/vertical-slice-mvp/issues/](./.scratch/vertical-slice-mvp/issues/) 已 done；改策展 [.scratch/change-curated-draft/issues/](./.scratch/change-curated-draft/issues/)（**01–06 TDD-done**；本刀闭合）。下一刀须 `/grill-with-docs`，不要默认 `/implement`
